...
public class ProductServiceImpl implements ProductService {
     ...
     *
     * El owner ya no se toma desde el DTO (dto.getUserId() fue eliminado).
     ...
     *
     * Se valida ownership antes de modificar: ADMIN puede editar
     * cualquier producto, USER solo los propios.
     */
    @Override
     ...
     * Se marca como deleted = true. Valida ownership antes de eliminar.
     */
    @Override
     ...
     *
     * currentUser viene desde el token JWT (UserDetailsImpl).
     * Se vuelve a consultar en base para asegurar que el usuario
     * siga existiendo y no esté eliminado lógicamente.
     */
